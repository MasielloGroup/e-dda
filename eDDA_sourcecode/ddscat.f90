...
! ISCR1,ISCR2,ISCR3,ISCR4 (used by EXTEND)
      ...
      REAL(WP) ::           &
        ...
        YLR(3),             &
        ZLR(3),             &
        RM(3,3) !RM added by NWB 12/22/14 after SMC
...
!      h_bar = 1.054572E-34_WP        !h_bar, j-s
      h_bar = 1.0545716E-27_WP        !h_bar, erg-s
!      h_bar2 = 6.582119E-19_WP       !h_bar, keV-s
      h_bar2 = 6.582119514E-16_WP     !h_bar, eV-s
...
!         ELENERGY = ELENERGY*1.60217646E-16_WP !Convert to Joules
         ELENERGY = ELENERGY*1.60217662E-9_WP !Convert to erg
...
!***
                  CALL ROTATE(A1,A2,AK1,CXE01,CXE02,BETA(IBETA),          &
                              ...
                              MXSCA,NSCAT,ENSC,EM1,EM2,AKSR,EM1R,EM2R,RM)

!RM added by NWB on 12/22/14 after SMC
...
!***
                  CALL GETFML(AKR,AK3,AKSR,BETADF,PHIDF,THETADF,DX,X0,CALPHA, &
                              ...
                              c,h_bar,h_bar2,velocity,e_charge,               &
...
9043  FORMAT(2F8.3,' = beta_min, beta_max ;  NBETA =',I2/2F8.3,               &
        ...
        5X,'CL int.') !Output edited by NWB 7/12/12,12/19/14
